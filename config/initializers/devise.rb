...
Devise.setup do |config|
  ...
  # config.pepper = "2a482e6a0e3e7ace28c6af022638f58e60d07f8cb77e3327035ca18b8319be397dbaa1563e70fabf4652d2e68a3b6cbc96a8602b0113e79e7388f817bf8d9998"
  ...
  require 'devise/strategies/doorkeeper_authenticatable'
  ...
  config.warden do |manager|
    ...
    manager.default_strategies(:scope => :user).unshift :doorkeeper_authenticatable
  end
